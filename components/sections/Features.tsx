const features = [
  ...
  },
  {
    icon: "⛏️",
    title: "マイクラプログラミング",
    desc: "大人気のマインクラフト教育版でプログラミングを学習。遊びながら「プログラミング的思考」が自然と身につきます。",
    color: "bg-green-50",
  ...
  },
  {
    icon: "🎨",
    title: "ファーストSTEAM",
    desc: "デジタルアート・ブロック造形・ロボットプログラミング・サイエンス工作の「4つのあそび」で発想力・表現力・論理的思考力を育てます。",
    color: "bg-purple-50",
  ...
  },
  {
    icon: "👩‍🏫",
    title: "丁寧な少人数指導",
    desc: "各回1〜6名の少人数制。お子さん一人ひとりのペースと興味に合わせてサポートします。",
    color: "bg-amber-50",
